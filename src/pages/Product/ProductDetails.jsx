...
export default function ProductDetails() {
  const { productUid } = useContext(PaymentContext);
        ...
        <div className="col-md-6">
          <div className="details-box shadow">
            ...
            <div className="mt-4 d-flex flex-wrap gap-2">
              <Link to="/cart" className="btn btn-success px-4">Add to Cart</Link>
              <Link to="/buynow" className="btn btn-warning px-4">Buy Now</Link>
            </div>
          </div>
        </div>
      </div>
