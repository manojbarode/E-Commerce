        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="row mb-3">
            <div className="col-md-6 mb-3 mb-md-0">
              ...
              <input type="number" name="price" className="form-control form-control-lg" onChange={handleBaseChange} placeholder="₹ 0" required />
            </div>
            <div className="col-md-6">
              <label className="form-label fw-semibold">Stock</label>
              <input type="number" name="stock" className="form-control form-control-lg" onChange={handleBaseChange} placeholder="0" required />
            </div>
          </div>
          ...
          {form.category && (
            <div className="mb-3">
              ...
              <select name="subcategory" className="form-select form-select-lg" onChange={handleBaseChange} required>
                <option value="">Select Subcategory</option>
                {categoryData[form.category].map((sub, i) => (<option key={i} value={sub}>{sub}</option>))}
              </select>
            </div>
          )}
            ...
            <>
              ...
              {dynamicFields[form.category]?.map((field, i) => (
                <div className="mb-3" key={i}>
                  ...
                  <input type="text" name={field} className="form-control form-control-lg" placeholder={`Enter ${field.replace("_"," ")}`} onChange={handleExtraChange} />
                </div>
              ))}
            </>
          )}
